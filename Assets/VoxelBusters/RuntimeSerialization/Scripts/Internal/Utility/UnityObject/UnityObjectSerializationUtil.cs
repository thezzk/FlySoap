...
namespace VoxelBusters.RuntimeSerialization.Internal
{
	public partial class UnityObjectSerializationUtil 
	{
		...
		internal static void Initialise ()
		{
            ...
            //Soap
            RSExtensionManager.AddNewExtension(typeof(CheckPoint),      new CheckPointRSExtension());
            RSExtensionManager.AddNewExtension(typeof(Death),           new DeathRSExtension());
            RSExtensionManager.AddNewExtension(typeof(ShowCollider),    new ShowColliderRSExtension());
        }
		...
		private static void CreateGhostPrefabContainer ()
		{
			...
			Transform		_containerTransform	= _RSManagerTransform.FindChild(kGhostPrefabContainerName);
