...
namespace Acrocatic {
	...
	public class PlayerJump : MonoBehaviour {
        ...
        private bool pressJumpDown=false;
        ...
        void Update () {
            ...
            if(!jump && pressJumpDown && jumps > 0 && !player.dashing && !player.sliding && !player.onLadder && (!player.crouching || (player.crouching && player.AllowedToStandUp()))) {
        ...
        {
#if MOBILE_INPUT
            pressJumpDown=CrossPlatformInputManager.GetButtonDown("Jump");
            pressJump=CrossPlatformInputManager.GetButton("Jump");
#endif

#if !MOBILE_INPUT

            pressJumpDown = Input.GetButtonDown("Jump");
